...
public class CoinChange {
    ...
    /**
     * Top-down optimization: Save the minimum numbers of coins to make 1, 2,... coins in cache
     */
    ...
    /**
     * Bottom-up optimization: Start from n = 1,2,... and save the result in cache till n
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(System.nanoTime() - start); // 40639208
        start = System.nanoTime();
        System.out.println(coinChange2(50));
        System.out.println(System.nanoTime() - start); // 39681409
        start = System.nanoTime();
        System.out.println(coinChange3(50));
        System.out.println(System.nanoTime() - start); // 38528
    }
}
